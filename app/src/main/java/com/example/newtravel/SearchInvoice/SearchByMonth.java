...
public class SearchByMonth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_by_month);
        intwidget();
        calllistener();
     }
            ...
            public void onClick(View v) {
               // Toast.makeText(SearchByDate.this,"here",Toast.LENGTH_SHORT).show();
                ...
                String Mon=getMonth(month.getSelectedItem().toString());
                                    Intent i=new Intent(SearchByMonth.this, listDataFfromInvoice.class);
                    i.putExtra("type","SearchByMonth");
